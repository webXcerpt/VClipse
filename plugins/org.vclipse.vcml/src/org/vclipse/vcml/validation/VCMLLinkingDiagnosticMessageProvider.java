...
public class VCMLLinkingDiagnosticMessageProvider extends LinkingDiagnosticMessageProvider {
	...
	public DiagnosticMessage getUnresolvedProxyMessage(ILinkingDiagnosticContext context) {
		...
		return new DiagnosticMessage(context.getLinkText() + " cannot be resolved", Severity.ERROR, issueCode, context.getLinkText(), referenceType, context.getContext().eClass().getName());
	}
}

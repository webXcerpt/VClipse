...
public class VCMLCompareExtractDifferencesDialog extends TitleAreaDialog {
	...
	/**
	 * The left side describes the new state(modified vcml for vcml case).
	 */
	public void setLeft(IFile file) {
		oldFile = file;
	}
	
	/**
	 * The right side describes the old state(state from the sap for vcml case).
	 */
	public void setRight(IFile file) {
		newFile = file;
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		group.setText("Sources for vcml compare operation");
	...
	protected void buttonPressed(int buttonId) {
		if(Dialog.OK == buttonId) {
			if(oldFile != null && newFile != null) {
				job.setFileToCompare(newFile, DifferenceSource.LEFT);
				job.setFileToCompare(oldFile, DifferenceSource.RIGHT);
	...
	private void validateEntries() {
		...
		if(generateExportFileButton.getSelection() && oldFile != null) {
			String newName = newFile.getName().replaceAll(ModelChangesProcessor.VCML_EXTENSION, ModelChangesProcessor.DIFF_VCML_EXTENSION);

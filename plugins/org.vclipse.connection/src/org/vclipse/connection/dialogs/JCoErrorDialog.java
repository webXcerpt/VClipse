 ...
 */
public class JCoErrorDialog extends MessageDialog {
	...
	protected Control createCustomArea(final Composite composite) {
		...
		link.setText("Please follow the VClipse installation instructions (see <a>VClipse User Guide</a>):\n" +
				     "Download SAP JCo3 from the SAP Service Marketplace and " +
				     "copy the files sapjco3.dll and sapjco3.jar into the directory " +

 ...
 */
class IDocErrorDialog extends MessageDialog {
	/** 
...
Download SAP IDoc3 from the SAP Service Marketplace and copy the file sapidoc3.jar into the directory plugins\org.vclipse.sapjco3_1.1.0 inside your Eclipse installation directory.''')

...
public class ConstraintExtractActionHandler extends ConstraintReader implements IBAPIActionRunner<Constraint> {
	...
	public void run(Constraint constraint, Resource resource, IProgressMonitor monitor, Map<String, VCObject> seenObjects, List<Option> options) throws JCoException {
		read(constraint.getName(), resource, monitor, seenObjects, options, true);
	}

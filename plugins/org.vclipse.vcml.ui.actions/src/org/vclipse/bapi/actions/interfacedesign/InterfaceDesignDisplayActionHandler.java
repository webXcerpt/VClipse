...
public class InterfaceDesignDisplayActionHandler extends InterfaceDesignReader implements IBAPIActionRunner<InterfaceDesign> {
	...
	public void run(InterfaceDesign interfaceDesign, Resource resource, IProgressMonitor monitor, Map<String, VCObject> seenObjects, List<Option> options) throws JCoException {
		read(interfaceDesign.getName(), (VcmlModel)resource.getContents().get(0), monitor, seenObjects, options, false);
	}

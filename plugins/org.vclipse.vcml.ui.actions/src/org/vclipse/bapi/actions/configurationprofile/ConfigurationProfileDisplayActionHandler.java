...
public class ConfigurationProfileDisplayActionHandler extends ConfigurationProfileReader implements IBAPIActionRunner<ConfigurationProfile>{
	...
	public void run(ConfigurationProfile configurationProfile, Resource resource, IProgressMonitor monitor, Map<String, VCObject> seenObjects, List<Option> options) throws JCoException {
		...
		read(material, configurationProfile.getName(), resource, monitor, seenObjects, options, false);
	}

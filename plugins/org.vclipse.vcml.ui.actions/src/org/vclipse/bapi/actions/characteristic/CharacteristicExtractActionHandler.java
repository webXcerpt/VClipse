...
public class CharacteristicExtractActionHandler extends CharacteristicReader implements IBAPIActionRunner<Characteristic> {
	...
	public void run(Characteristic cstic, Resource resource, IProgressMonitor monitor, Set<String> seenObjects, List<Option> options) throws JCoException {
		read(cstic.getName(), (Model)resource.getContents().get(0), monitor, seenObjects, options, false);
	}

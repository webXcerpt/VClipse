...
public class ProcedureCreateChangeActionHandler extends BAPIUtils implements IBAPIActionRunner<Procedure> {

	public boolean isEnabled(Procedure object) {
		return isConnected() && hasBody(object);
	}

	public void run(Procedure object, Resource resource, IProgressMonitor monitor, Map<String, VCObject> seenObjects, List<Option> globalOptions) throws JCoException {
		beginTransaction();

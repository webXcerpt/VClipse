...
public class VariantFunctionDisplayActionHandler extends VariantFunctionReader implements IVCMLOutlineActionHandler<VariantFunction>{
	...
	public void run(VariantFunction variantFunction, Resource resource, IProgressMonitor monitor) throws JCoException {
		read(variantFunction.getName(), (Model)resource.getContents().get(0), monitor, new HashSet<String>(), false);
	}

...
/** 
 */
final class IDoc2JCoIDocPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	/** 
	 */
	...
	override protected void createFieldEditors() {
		var Composite parent = getFieldEditorParent()
		...
		addField(
			new BooleanFieldEditor(IUiConstants.NUMBERS_VIA_RFC, "Retrieve new UPS and IDoc numbers via RFC", parent))

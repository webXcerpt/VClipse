...
public abstract class IDocsSender implements IIDocsSender {
   ...
   * @param shell
   */
  public IDocsSender(final Shell shell) {
   ...
   */
  @Override
  public abstract IDocSenderStatus send(final List<IDocDocument> idocs, final IConnectionHandler handler, final IProgressMonitor monitor);
}
